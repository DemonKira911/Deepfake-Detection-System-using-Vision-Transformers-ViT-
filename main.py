...
# Splitting the dataset into training and testing sets using an 95-5 split ratio.
dataset = dataset.train_test_split(test_size=0.05, shuffle=True, stratify_by_column="label")
